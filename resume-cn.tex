...
\role{本科，在读}{计算机科学与技术; GPA 3.82/4.00; 排名 24/205}
...
\begin{itemize}
  ...
  \item 面向 GPU 统一虚拟内存的数据管理优化技术
        ...
        \end{itemize}
  \item 基于 LLVM-IR 的 ARMv7 在线 JIT 编译器
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{求职岛} (微信小程序, Vue, Django)：
        校内实验室招聘平台，支持微信小程序与 Web 端；合作（主要负责后端开发）
\end{itemize}
...
\begin{itemize}
  ...
  \item \datedline{第十三届全国大学生数学竞赛·北京赛区（三等奖）}{2021.12}
